    ...
    <>
      ...
      <header className="hero">
        ...
        <div className="wrap hero-in">
          ...
          <p className="subline">Every event worth being at, near you — concerts, festivals, nightlife and daytime. One honest price. No Zora booking fee.</p>
      ...
      <section id="app">
        <div className="wrap">
          <div className="organize">
            ...
            <p>Launch a custom Zora subdomain in two minutes — your own storefront, your data, built-in marketing, and one honest price your crowd will love. No Zora booking fee passed to them.</p>
